(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.nobleEd25519 = {}, global.require$$0));
	...
	exports.utils = {
	    ...
	    randomPrivateKey: (bytesLength = 32) => {
	        if (typeof self == 'object' && 'crypto' in self) {
	            ...
	            const { randomBytes } = require$$0__default['default'];
	    ...
	    sha512: async (message) => {
	        if (typeof self == 'object' && 'crypto' in self) {
	            ...
	            const { createHash } = require$$0__default['default'];
	...
	const index = /*@__PURE__*/getDefaultExportFromCjs(ed25519);
